...
static const GPathInfo DIGIT_LOCATIONS = {
  12, (GPoint []) {
    { PBL_DISPLAY_WIDTH/2 + DIGIT_X_POS - DIGIT_RECT_SIZE_W/2, 2 }, // 1
    ...
    { PBL_DISPLAY_WIDTH/2 + DIGIT_X_POS - DIGIT_RECT_SIZE_W/2, PBL_DISPLAY_HEIGHT - DIGIT_RECT_SIZE_H - 2 }, // 5
    { PBL_DISPLAY_WIDTH/2 - DIGIT_RECT_SIZE_W/2, PBL_DISPLAY_HEIGHT - DIGIT_RECT_SIZE_H - 2 }, // 6
    { PBL_DISPLAY_WIDTH/2 - DIGIT_X_POS - DIGIT_RECT_SIZE_W/2, PBL_DISPLAY_HEIGHT - DIGIT_RECT_SIZE_H - 2 }, // 7
    ...
    { PBL_DISPLAY_WIDTH/2 - DIGIT_X_POS - DIGIT_RECT_SIZE_W/2, 2 }, // 11
    { PBL_DISPLAY_WIDTH/2 - DIGIT_RECT_SIZE_W/2, 2 }, // 12
  }
};
